...
&ensp;&ensp;&ensp;&ensp;随着深度学习技术的发展，人工智能的门槛逐步下降，借助大量数据和开源算法即可获得相应的智能，已经成为人们的共识。在以<a href="https://www.openinnolab.org.cn/">浦育平台</a>、<a href="https://xedu.readthedocs.io/zh/master/about.html#">XEdu</a>为代表的人工智能开发工具的支持下，中小学生也能用训练人工智能模型的形式，解决一些真实问题。接下来以“解决真实问题”作为核心问题，介绍了适合青少年使用的模型训练和部署工具，并以“害虫识别”为例，介绍了具体的工作流程和技术工具，形成技术地图。

【关键词】新一代人工智能 人工智能教育 XEdu

&ensp;&ensp;&ensp;&ensp;数据、算法和算力被公认为推动人工智能发展的三驾马车。随着深度学习技术的发展，人工智能的门槛逐步下降。从2021年开始，我陆续在杂志上发表以“用人工智能解决真实问题”为核心的系列文章，介绍以浦育平台、XEdu为代表系列人工智能开发工具。越来越多的老师开始认同，借助大量数据和开源算法，训练具备一定智能的模型，从而解决一些简单的真实问题，应该成为中小学人工智能课程的核心内容。

&ensp;&ensp;&ensp;&ensp;2023年12月，我在第十一届中小学STEAM教育大会上介绍了一个AI开源课程的众筹计划。这个课程以真实问题解决为导向，以项目式学习的方式组织课程内容，引发了很多老师的关注和支持。有天晚上，广州电教馆的龙丽嫦老师特意打电话来求助：能不能为一线教师提供一份用AI解决问题的技术地图，让老师们能快速入门？

## 一、用AI解决真实问题的流程分析

&ensp;&ensp;&ensp;&ensp;人工智能的开发框架很多，相关的工具也很多。龙丽嫦老师的需求是很有代表性的，因为老师们在缺少对工具全面了解的情况下，很难设计出一份合理的技术地图，容易走弯路。为了能更加清晰地表述，我以劳动和科学教育中常常遇到的昆虫识别问题为例，结合一个害虫识别应用的开发过程来介绍各种技术工具的选择。
...
&ensp;&ensp;&ensp;&ensp;如上所述，我们成功地完成了一个昆虫识别的AI应用。限于篇幅，本文没有展开介绍如何从摄像头中获取图片，如何根据推理结果做出不同的执行动作等。在这个过程中，学生们有多种可选的方法和工具，具体要视具体情况作出合适的选择。而本文在介绍各种技术的过程中，也展示了人工智能教育区别于传统编程教育的最重要标志，那就是要训练AI模型。而在浦育平台和XEdu的帮助下，训练模型真的没有什么难度。“右手写代码，左手训模型”，这应该是中小学人工智能教育的常态。
