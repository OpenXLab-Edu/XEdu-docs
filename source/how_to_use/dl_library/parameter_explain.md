...
学习速率（learning rate，lr）又称学习率、学习步长等。我们可以以看书做比喻，学习率就像看书时翻页的速度，翻页速度过快，可能会错过重要内容或者理解不够深入，比如只看标题和目录，能够把握大意，但并不精通，这样可以快速提升模型的准确率，但不够精细。学习速率小，表示翻页速度过慢，就好像读书时咬文嚼字，能够学习的很精细，但用的时间也自然更长。简单解释就是，学习率过小，训练过程会很缓慢，学习率过大时，模型精度会降低。
