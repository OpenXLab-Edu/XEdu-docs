...
<thead>
  <tr>
    <th rowspan="2">算法名称</th>
    <th rowspan="2">适合任务</th>
    <th rowspan="2">典型任务</th>
    <th rowspan="2">算法解释</th>
    <th rowspan="10">常用参数及其默认值</th>
  </tr>
</thead>
<tbody align="center">
  <tr>
    <td class="tg-zk71">线性回归（LinearRegression）</td>
    <td>回归</td>
...
<tbody align="center">
  <tr>
    <td class="tg-zk71">最近邻分类（KNN, K-Nearest Neighbors）</td>
    <td>分类</td>
...
<tbody align="center">
  <tr>
    <td class="tg-zk71">支持向量机（SVM, Support Vector Machine）</td>
    <td>分类/回归</td>
...
<tbody align="center">
  <tr>
    <td class="tg-zk71">决策树算法（CART）</td>
    <td>分类/回归</td>
    <td>适用于客户分级、疾病诊断等。</td>
...
<tbody align="center">
  <tr>
    <td class="tg-zk71">随机森林算法（Random Forest）</td>
    <td>分类/回归</td>
...
<tbody align="center">
  <tr>
    <td class="tg-zk71">自适应增强算法（AdaBoost）</td>
    <td>分类/回归</td>
...
<tbody align="center">
  <tr>
    <td class="tg-zk71">多层感知机算法（MLP）</td>
    <td>分类/回归</td>
