...
model = mmeducls(backbone='MobileNet')
...
model = mmedudet(backbone='SSD_Lite')
...
更多模型转换和应用的教程详见[后文](https://xedu.readthedocs.io/zh-cn/master/how_to_use/support_resources/model_convert.html)。
